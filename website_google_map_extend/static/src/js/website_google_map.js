function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('odoo-google-map'), {
        zoom: 8,
        center: {lat: 42.6839624, lng: 25.2512516},
    ...
    var partners = new google.maps.MarkerImage('/website_google_map_extend/static/src/img/partners.png', new google.maps.Size(25, 25));
    var partner_url = document.body.getAttribute('data-partner-url') || '';
    var markers = [];
    var options = {
        imagePath: '/website_google_map_extend/static/src/lib/images/m'
    };
